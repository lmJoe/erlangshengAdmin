...
export default {
  ...
  methods: {
    ...
    changedetailTime() {
      ...
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      window.LogList.checkLog('二郎神后台管理系统',this.title,'每日数据表格时间选择',detailList);
    },
    //用户top10跳转
    userSkipBtn() {
     this.$router.push({ name: 'userSkipTop10', params: {rightName:this.rightName,rightSelect:this.rightSelect} });
    ...
    //   window.open(href, '_blank')
      ...
      var detailArr = [];
      detailArr[0] = rightChoseName;
      detailArr[1] = rightSelectName;
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      window.LogList.checkLog('二郎神后台管理系统',this.title,'用户观看top10',detailList);
    },
    //视频top10跳转
    videoSkipBtn() {
      this.$router.push({ name: 'videoSkipTop10', params: {rightName:this.rightName,rightSelect:this.rightSelect} });
      // const {href} = that.$router.resolve({
      //   path: 'videoSkipTop10',
      //   query: {
      //     pdf: JSON.stringify(this.pdf)
      ...
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      //window.LogList.checkLog(a,b,c,d)
      //a-当前操作平台名   b-当前页面名称   c-当前操作动作  d-操作详情
      window.LogList.checkLog('二郎神后台管理系统',this.title,'视频播放top10',detailList);
    },
    //获取昨日今日概况数据
    getAppRecentData (){
      var that = this;
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getPlayGeneralData+"?Type="+that.rightName+'&SourceType='+that.rightSelect,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    changeEchartBtn1() {
      ...
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      window.LogList.checkLog('二郎神后台管理系统',this.title,'视频播放趋势图进度状态选择',detailList);
    },
    changeEchartBtn2() {
      ...
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      window.LogList.checkLog('二郎神后台管理系统',this.title,'视频播放趋势图数量及占比选择',detailList);
    },
    //获取总趋势图数据
    getPartData (){
      var that = this;
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getVideoCount+"?Type="+that.rightName+"&VideoPlayType="+that.tabPositionAll+'&starttime='+that.echartDefaultDateAll[0]+'&endtime='+that.echartDefaultDateAll[1]+'&SourceType='+that.rightSelect,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getPartDataBF (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getVideoPlayTrend+"?Type="+that.rightName+"&VideoPlayBehavior="+that.tabPosition1+'&starttime='+that.echartDefaultDate[0]+'&endtime='+that.echartDefaultDate[1]+'&SourceType='+that.rightSelect+'&VideoPlayBehaviorType='+that.tabPosition2,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getPlayTypeBF (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getVideoTypeData+"?Type="+that.rightName+'&SourceType='+that.rightSelect,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getAppUserPlayTop() {
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getAppUserPlayTop+"?Type="+this.rightName+'&SourceType='+this.rightSelect+'&TopCount=10',
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getAppVideoPlayTop() {
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getAppVideoPlayTop+"?Type="+this.rightName+'&SourceType='+this.rightSelect+'&TopCount=10',
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getDetails (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getPlayVideoDetails+"?Type="+that.rightName+"&SourceType="+that.rightSelect+"&starttime="+that.detailDefaultDate[0]+"&endtime="+that.detailDefaultDate[1],
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
