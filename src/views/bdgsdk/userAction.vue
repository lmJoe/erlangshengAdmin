      ...
      <div class="surveyContainer" v-show="activeName=='right'">
        ...
        <div class="videoDataBottom">
          <el-table
            ...
            <el-table-column prop="clickpv" label="点击商品次数" align="center"></el-table-column>
          </el-table>
          <el-pagination
  ...
  methods: {
    ...
    changeUserTime(){
      ...
      var data = {
        ...
        starttime:that.userDefaultDate[0],
        endtime:that.userDefaultDate[1],
      ...
      http({  
        //这里是你自己的请求方式、url和data参数
        method: 'POST',
        url:URL.recordUrl.UserClickActionSDK,
        data: data,
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
      ...
      detailArr[1] =  that.userDefaultDate[0]+'至'+that.userDefaultDate[1];
      detailArr[2] =  that.tagValue;
      detailArr[3] =  "用户点击排行";
      detailArr[4] =  "第"+this.pageIndex1+"页";
    ...
    changeAllAccount(){
      if(this.activeName=="left"){
        this.searchBtn();
      }else if(this.activeName=="right"){
        this.changeUserTime();
      }
      this.loading = true;
    },
