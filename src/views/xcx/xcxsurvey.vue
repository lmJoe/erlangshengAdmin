        ...
        <div class="surveyTop">
          <div class="surveyDataTop">
            <el-row :gutter="20">
              ...
              <el-col :span="3"><div class="grid-content bg-purple surveySort">启动人数</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveySort">视频播放量</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveySort">人均播放量</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveySort">人均停留时长</div></el-col>
          ...
          <div class="surveyDataBottom">
            <el-row :gutter="20" v-for="(item,index) in recentData" :key="index">
              <el-col :span="1.5"><div class="grid-content bg-purple surveyDatatitle">昨日</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveyDataNum">{{item.startNum}}</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveyDataNum">{{item.startUser}}</div></el-col>
...
export default {
  ...
  data () {
    return {
      ...
      rightName: 43,//右上角选项类型值 43-头条恰饭视频  103-头条爆米花视频  102-头条美好视频
      loading: true,
  ...
  methods: {
    ...
    getAppRecentData (){
      ...
      http({  
        ...
        method: 'get',
        url:URL.recordUrl.getxcxRecentData+"?appid="+this.rightName,
        data: {},
    ...
    getPartData (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getxcxGetPartData+"?appid="+that.rightName+"&type="+that.activeName+"&startTime="+that.echartDefaultDate[0]+"&endtime="+that.echartDefaultDate[1],
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getDetails (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getxcxGetDetails+"?appid="+that.rightName+"&StartTime="+that.detailBoxDate[0]+"&EndTime="+that.detailBoxDate[1]+'&type='+that.activeName,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    downloadE(){
      ...
      // detailList.push(detailArr);
      // detailList = JSON.stringify(detailList);
      // window.LogList.checkLog('二郎神后台管理系统',this.title,'趋势图下载',detailList);
    },
    changeBoxTime (){
...
<style scoped lang="less">
 @import '../../assets/css/xcxsurvey.less';
