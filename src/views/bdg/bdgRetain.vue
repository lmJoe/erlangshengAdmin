        ...
        <div class="surveyTop">
          <div class="surveyDataTop">
            <el-row :gutter="20">
              ...
              <el-col :span="3"><div class="grid-content bg-purple surveySort">注册率</div></el-col>
  ...
  methods: {
    ...
    getAppRecentData (){
      ...
      http({
        ...
        method: 'get',
        url:URL.recordUrl.getbdganageneraldata,
        data: {},
    ...
    getPartData (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getbdganaechartsdata+"?partnum="+that.activeName,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getDetails (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getbdganadetailsdata,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
