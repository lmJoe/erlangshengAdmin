...
export default {
  ...
  methods: {
    ...
    changeRight() {
      console.log("value",this.MediaName);
    ...
    //用户top10跳转
    userSkipBtn() {
     this.$router.push({ name: 'userSkipTop10', params: {rightName:this.rightName} });
    ...
    //视频top10跳转
    videoSkipBtn() {
      this.$router.push({ name: 'sdkVideoSkipTop10', params: {MediaName:this.MediaName,CompanyName:this.CompanyName} });
      // const {href} = that.$router.resolve({
      //   path: 'videoSkipTop10',
      //   query: {
      //     pdf: JSON.stringify(this.pdf)
      ...
      var detailList = [];
      var detailArr = [];
      detailArr[0] =  this.MediaName;
      detailArr[1] =  this.CompanyName;
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
    ...
    getAppRecentData (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getsdkPlayGeneralData+"?MediaName="+that.MediaName+"&CompanyName="+that.CompanyName,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    changeEchartBtnAll() {
      ...
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      window.LogList.checkLog('二郎神后台管理系统',this.title,'总趋势图分类选择',detailList);
    },
    changeEchartBtn1() {
      ...
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      window.LogList.checkLog('二郎神后台管理系统',this.title,'视频播放趋势图左侧条件选择',detailList);
    },
    changeEchartBtn2() {
      ...
      detailList.push(detailArr);
      detailList = JSON.stringify(detailList);
      window.LogList.checkLog('二郎神后台管理系统',this.title,'视频播放趋势图右侧条件选择',detailList);
    },
    //获取总趋势图数据
    getPartData (){
      var that = this;
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getsdkPlayVideoCount+"?MediaName="+that.MediaName+"&CompanyName="+that.CompanyName+"&VideoPlayType="+that.tabPositionAll+'&starttime='+that.echartDefaultDateAll[0]+'&endtime='+that.echartDefaultDateAll[1],
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getPartDataBF (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getsdkVideoPlayTrend+"?MediaName="+that.MediaName+"&CompanyName="+that.CompanyName+"&VideoPlayBehavior="+that.tabPosition1+'&starttime='+that.echartDefaultDate[0]+'&endtime='+that.echartDefaultDate[1]+'&VideoPlayBehaviorType='+that.tabPosition2,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getPlayTypeBF (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getsdkVideoTypeData+"?MediaName="+that.MediaName+"&CompanyName="+that.CompanyName,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getAppUserPlayTop() {
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getAppUserPlayTop+"?MediaName="+this.MediaName+"&CompanyName="+that.CompanyName+'&TopCount=10',
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getAppVideoPlayTop() {
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getsdkVideoPlayTop+"?MediaName="+this.MediaName+"&CompanyName="+that.CompanyName+'&TopCount=10',
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getDetails (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getsdkPlayDetails+"?MediaName="+that.MediaName+"&CompanyName="+that.CompanyName+"&starttime="+that.detailDefaultDate[0]+"&endtime="+that.detailDefaultDate[1],
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
...
<style scoped lang="less">
 @import '../../assets/css/sdkPlayData.less';
