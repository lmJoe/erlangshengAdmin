        ...
        <div class="surveyTop">
          <div class="surveyDataTop">
            <el-row :gutter="20">
              ...
              <el-col :span="3"><div class="grid-content bg-purple surveySort" >浏览量(PV)</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveySort" >活跃账户</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveySort" >新增用户</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveySort" >新增账户</div></el-col>
          ...
          <div class="surveyDataBottom">
            <el-row :gutter="20" v-for="(item,index) in recentData" :key="index">
              <el-col :span="1.5"><div class="grid-content bg-purple surveyDatatitle">昨日</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveyDataNum" >{{item.activeUser}}</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveyDataNum" >{{item.activeAccount}}</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveyDataNum" >{{item.newUser}}</div></el-col>
              <el-col :span="3"><div class="grid-content bg-purple surveyDataNum" >{{item.newAccount}}</div></el-col>
          ...
          <div class="surveyEchartBox">
            <div class="surveyEchartlist">
              <el-tabs v-model="activeName" @tab-click="changeEchartBtn">
                ...
                <el-tab-pane label="活跃账户" name="1" >
                  <div id="echart1" style="height:400px;"></div>
                </el-tab-pane>
                <el-tab-pane label="新增用户" name="2" >
                  <div id="echart2" style="height:400px;"></div>
                </el-tab-pane>
                <el-tab-pane label="新增账户" name="2" >
                  <div id="echart2" style="height:400px;"></div>
                </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    bindDrawal(){
      this.detailBoxDate.push(this.common.formatDate(-6),this.common.formatDate(0))
    ...
    getAppRecentData (){
      ...
      http({
        ...
        method: 'get',
        url:URL.recordUrl.getAppRecentData+"?id="+this.rightName+"&SourceType="+that.rightSelect,
        data: {},
    ...
    getPartData (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getPartData+"?id="+that.rightName+"&type="+that.activeName+"&startTime="+that.echartDefaultDate[0]+"&endtime="+that.echartDefaultDate[1]+"&SourceType="+that.rightSelect,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    getDetails (){
      ...
      http({
        //这里是你自己的请求方式、url和data参数
        method: 'get',
        url:URL.recordUrl.getDetails+"?id="+that.rightName+"&startTime="+that.detailBoxDate[0]+"&endtime="+that.detailBoxDate[1]+"&SourceType="+that.rightSelect,
        data: {},
        //假设后台需要的是表单数据这里你就可以更改
        headers: {
          "Content-Type":"application/x-www-form-urlencoded",
    ...
    //获取表格导出
    downloadE(){
      this.downloadExcelUrl = URL.recordUrl.getAppexport+"?id="+this.rightName+"&startTime="+this.echartDefaultDate[0]+"&endtime="+this.echartDefaultDate[1]+"&SourceType="+this.rightSelect;
    },
    changeBoxTime (){
...
<style scoped lang="less">
 @import '../../assets/css/mohesurvey.less';
